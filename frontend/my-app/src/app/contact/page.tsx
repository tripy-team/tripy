			...
			<div className="mx-auto max-w-[800px] space-y-12 px-4">
				...
				<section className="space-y-3.5">
					...
					<a
						...
						className="inline-block text-[14px] text-white/90 underline decoration-white/30 underline-offset-4 transition hover:decoration-white/70 md:text-[15px]"
					>
				...
				<section className="space-y-3.5">
					...
					<div className="flex flex-col">
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							className="inline-flex items-center gap-2 text-[14px] text-white/90 transition hover:text-white md:text-[15px]"
						>
							<svg
								viewBox="0 0 24 24"
							...
							<span className="font-semibold">Eric Zhong</span>
						</a>
						<a
						...
						>
							...
							<span className="font-semibold">David Garzon</span>
						</a>
					</div>
				</section>
			</div>
